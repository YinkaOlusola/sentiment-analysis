...
# Load your raw data
raw = pd.read_csv("resources/train")
...
def main():
	...
	#edsa_logo_image = Image.open('resources/imgs/EDSA_.png')
	...
	if selection == "Prediction":
		...
		#	predictor = joblib.load(open(os.path.join("resources/random_forest_model"),"rb"))
